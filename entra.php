...
<!--        <script src="./js/cookiechoices.js"></script>
        ...
        <section class="entra-area section_padding_100 mt-100">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-10">
                        <div class="entra-heading-text text-center mb-100">
                            <span></span>
                            <h2>GALLERY</h2>
                            <p></p>
                        </div>
                    ...
                    <div class="col-10">
                        <div class="row" data-aos="fade-up" data-aos-delay="100">
                            <div class="col-lg-12">
                                <p>
                                    LE IMMAGINI CHE APPAIONO IN QUESTO SITO APPARTENGONO AL FOTOGRAFO CHE HA REALIZZATO GLI SCATTI E SONO PROTETTE IN TUTTO IL MONDO DALLA 
                                    LEGGE SUL DIRITTO DI AUTORE - COPYRIGHT
                                </p>
                                <p>
                                    La seguente galleria mostra immagini di nudo senza censura. Per poterle vedere devi essere maggiorenne.
                                </p>
                                <p style="text-align: center;">
                                    <a href="./index.php"><font color="#ff0000">NON SONO MAGGIORENNE</font></a> 
                                    |
                                    <a href="./galleryNudeArt.php"><font color="#17a000">DICHIARO DI ESSERE MAGGIORENNE</font></a>
                                </p>
                            </div>
                        </div>
                        <div class="row" data-aos="fade-up" data-aos-delay="200">
                            <div class="col-lg-12">
                                <p>
                                    IMAGES APPEARING ON THIS SITE BELONG TO THE PHOTOGRAPHER THAT TOOK THE SHOTS. THESE ARE PROTECTED WORLDWIDE BY THE LAW ON COPYRIGHT
                                </p>
                                <p>
                                    The following gallery displays uncensored nude images. You must be of legal age to see them.
                                </p>
                                <p style="text-align: center;">
                                    <a href="./index.php"><font color="#ff0000">I AM UNDER 18</font></a>
                                    |
                                    <a href="./galleryNudeArt.php"><font color="#17a000">I AM OVER 18</font></a>
                                </p>
                            </div>
                        </div>
                    </div>
